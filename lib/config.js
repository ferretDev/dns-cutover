...
export const CONFIG_KEYS = ['ENOM_UID', 'ENOM_PW', 'ENOM_ENV', 'CF_API_TOKEN', 'CF_ACCOUNT_ID', 'POSTMARK_TOKEN', 'REPORT_FROM', 'REPORT_TO'];
// Values shown unmasked in the UI — identifiers, not secrets.
const PLAIN_KEYS = new Set(['ENOM_ENV', 'REPORT_FROM', 'REPORT_TO']);
