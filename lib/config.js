...
export const CONFIG_KEYS = [
  ...
  'POSTMARK_TOKEN', 'REPORT_FROM', 'REPORT_TO', 'REPORT_SCHEDULE_HOURS',
];
// Values shown unmasked in the UI — identifiers, not secrets.
const PLAIN_KEYS = new Set(['PROVIDER', 'ENOM_ENV', 'NAMECHEAP_USER', 'NAMECHEAP_CLIENT_IP', 'REPORT_FROM', 'REPORT_TO', 'REPORT_SCHEDULE_HOURS']);
