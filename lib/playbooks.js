...
export const BUILTIN_PLAYBOOKS = {
  'Full migration': {
    steps: { zone: true, records: true, redirects: true, dmarc: true, unproxy: true, verify: true, cutover: true },
    unproxyPatterns: MAIL_PATTERNS,
    builtin: true,
  },
  'Stage only (no cutover)': {
    steps: { zone: true, records: true, redirects: true, dmarc: true, unproxy: true, verify: true, cutover: false },
    unproxyPatterns: MAIL_PATTERNS,
    builtin: true,
  },
  'Fixes + verify only': {
    steps: { zone: false, records: false, redirects: true, dmarc: true, unproxy: true, verify: true, cutover: false },
    unproxyPatterns: MAIL_PATTERNS,
    builtin: true,
  },
};
